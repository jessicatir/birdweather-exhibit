...
class TopSpeciesDetectionList extends StatelessWidget {
  const TopSpeciesDetectionList({required this.topSpecies, super.key});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: List.generate(topSpecies.species.length, (index) {
